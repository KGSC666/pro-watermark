                ...
                {!hasImage && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-6 pointer-events-none z-0 px-8 text-center animate-in fade-in zoom-in-95 duration-700">
                        ...
                        <div className="max-w-[280px]">
                            <span className="text-base md:text-lg font-semibold tracking-tight text-white/60 block">
                                {t('ready_to_process')}
                            </span>
                            <span className="text-xs md:text-sm text-neutral-600 mt-2 block leading-relaxed">
                                {t('drop_hint')}
                            </span>
                        </div>
                    </div>
