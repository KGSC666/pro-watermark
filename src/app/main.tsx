        ...
        controls={
          <div className="flex flex-col gap-6 overflow-x-hidden">
            ...
            {config.type === "text" ? (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <input data-vaul-no-drag onPointerDown={(e) => e.stopPropagation()} type="range" min="1" max="25" step="0.5" value={config.sizePct} onChange={(e) => setConfig({...config, sizePct: parseFloat(e.target.value)})} className="w-full accent-white" />
                </div>
                <div>
            ...
            <section>
              ...
              <input data-vaul-no-drag onPointerDown={(e) => e.stopPropagation()} type="range" min="0" max="1" step="0.01" value={config.opacity} onChange={(e) => setConfig({...config, opacity: parseFloat(e.target.value)})} className="w-full accent-white" />
            </section>
